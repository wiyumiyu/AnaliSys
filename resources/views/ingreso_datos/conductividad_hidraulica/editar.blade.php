...
@section('title', 'Editar muestra - Conductividad Hidráulica')
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex flex-wrap gap-4 justify-content-between align-items-center">
                    ...
                    <h5 class="mb-0 fw-semibold">
                        Editar muestra – Conductividad Hidráulica {{ $muestra->idlab }}
                    </h5>
            ...
            <div class="card-body">
                ...
                <form method="POST"
                      action="{{ route('conductividad_hidraulica.muestra.update', $muestra->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <br><br>
                    <h5 class="fw-semibold mb-3">
                        Resultados de Conductividad Hidráulica
                    </h5>
