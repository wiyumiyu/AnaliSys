...
@section('title', 'Conductividad Hidráulica - Archivos')
                ...
                <div class="d-flex gap-4 justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-3 align-items-center">
                        ...
                        <form class="d-flex align-items-center gap-3 m-0"
                              action="{{ route('conductividad_hidraulica.importar') }}"
                ...
                <table id="default_datatable"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <h6 class="mb-0">
                                    <a href="{{ route('conductividad_hidraulica.muestras', $l->id_archivo) }}">
                                        {{ $l->archivo }}
                                    </a>
                                </h6>
