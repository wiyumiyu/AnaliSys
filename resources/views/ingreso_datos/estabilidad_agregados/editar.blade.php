...
@section('title', 'Editar muestra - Estabilidad de agregados')
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex flex-wrap gap-4 justify-content-between align-items-center">
                    ...
                    <h5 class="mb-0 fw-semibold">
                        Editar muestra – Estabilidad de agregados {{ $muestra->idlab }}
                    </h5>
            ...
            <div class="card-body">
                ...
                <form method="POST"
                      action="{{ route('estabilidad_agregados.muestra.update', $muestra->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <br><br>
                    <h5 class="fw-semibold mb-3">
                        Resultados de estabilidad de agregados
                    </h5>
