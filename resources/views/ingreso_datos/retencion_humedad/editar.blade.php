...
@section('title', 'Editar muestra - Retención de Humedad')
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex flex-wrap gap-4 justify-content-between align-items-center">
                    ...
                    <h5 class="mb-0 fw-semibold">
                        Editar muestra – Retención de Humedad {{ $muestra->idlab }}
                    </h5>
            ...
            <div class="card-body">
                ...
                <form method="POST"
                      action="{{ route('retencion_humedad.muestra.update', $muestra->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <br><br>
                    <h5 class="fw-semibold mb-3">
                        Resultados de retención de humedad
                    </h5>
