...
@section('title', 'Muestras del archivo - Retención de Humedad')
                        ...
                        @forelse($muestras as $m)
                            ...
                            <tr>
                                ...
                                <td class="{{ $filaInactiva }}">
                                    <a href="{{ route('retencion_humedad.muestra.edit', $m->id_muestra) }}"
                                ...
                                <td class="{{ $filaInactiva }}">{{ $m->presion_aplicada }}</td>
                                <td class="{{ $filaInactiva }}">{{ $m->ph1_L1 }}</td>
                                <td class="{{ $filaInactiva }}">{{ $m->ps1_L1 }}</td>
                                <td class="{{ $filaInactiva }}">{{ $m->ph_L2 }}</td>
                                <td class="{{ $filaInactiva }}">{{ $m->ps2_L2 }}</td>
                                <td class="{{ $filaInactiva }}">{{ $m->L1 }}</td>
                                <td class="{{ $filaInactiva }}">{{ $m->L2 }}</td>
...
function confirmarEstadoMuestra(id, estado) {
    ...
    modalForm.action = `/ingreso-datos/retencion-humedad/muestra/${id}/estado`;
...
function confirmarEliminarMuestra(id) {
    ...
    modalForm.action = `/ingreso-datos/retencion-humedad/muestra/${id}`;
