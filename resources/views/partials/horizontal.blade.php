        ...
        <ul class="pe-horizontal-menu list-unstyled" id="horizontal-menu">
            ...
            <li class="pe-slide pe-has-sub">
                ...
                <ul class="pe-slide-menu collapse" id="collapseDashboards">
                    ...
                    <li class="pe-slide-item">
                        <a href="dashboard-crm" class="pe-nav-link">
                            CRM
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="dashboard-ecommerce" class="pe-nav-link">
                            E-Commerce
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="dashboard-logistic" class="pe-nav-link">
                            Logistics
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="dashboard-project" class="pe-nav-link">
                            Projects
                        </a>
                    </li>
                </ul>
                        ...
                        <ul class="pe-slide-menu collapse" id="collapseAcademy">
                            <li class="pe-slide pe-has-sub">
                                ...
                                <ul class="pe-slide-menu collapse" id="collapseCourses">
                                    ...
                                    <li class="pe-slide-item">
                                        <a href="apps-academy-single-category" class="pe-nav-link">Category Single</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="pe-slide pe-has-sub">
            ...
            <li class="pe-slide pe-has-sub">
                ...
                <ul class="pe-slide-menu collapse list-unstyled" id="collapseBaseUI" data-simplebar style="height: 400px;">
                    <li class="slide pe-nav-content1">
