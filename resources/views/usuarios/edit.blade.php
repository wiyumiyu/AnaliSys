    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex flex-wrap gap-4 justify-content-between align-items-center">
                    ...
                    <div class="d-flex flex-wrap gap-3 align-items-center">
                        <a href="{{ $esPerfilPropio && session('rol') !== 'ADMIN' 
            ? route('dashboard') 
            ...
            <div class="card-body">
                ...
                @if($esPerfilPropio)
                <form method="POST" action="{{ route('usuarios.update_perfil') }}">
                    @else
        ...
        `);
                                    ...
                                    if (confirmBtn) {
                                        confirmBtn.addEventListener('click', function () {
                                            ...
                                            if (deleteType === 'correo')
                                                body += `&del_correo=${deleteId}`;
                                            if (deleteType === 'telefono')
                                                body += `&del_tel=${deleteId}`;
